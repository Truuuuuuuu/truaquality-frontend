...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-board-border transition-colors hover:bg-board-panel-raised/50 has-aria-expanded:bg-board-panel-raised/50 data-[state=selected]:bg-board-panel-raised",
        className
      )}
      {...props}
    />
